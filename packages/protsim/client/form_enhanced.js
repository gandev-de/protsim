  ...
  values: function (form) {
    ...
    for (var i = 0; i < form.length; i++) {
      ...
      if (typeof value !== 'undefined') {
        var object_path = field.name.split('.');
        if (object_path.length > 1) {
          if (typeof fields[object_path[0]] === 'undefined') {
            fields[object_path[0]] = {};
          }

          fields[object_path[0]][object_path[1]] = value;
        } else {
          fields[name] = value;
        }
      }
